...
var bowImage, arrowImage, green_balloonImage, red_balloonImage, pink_balloonImage ,blue_balloonImage, backgroundImage, boyy, boyx;

function preload(){
  
  backgroundImage = loadImage("background0.png");
  boyy = loadImage("boyy.png");
...
function setup() {
 ...
 // bow.scale = 1;
  boyx = createSprite(480,220,20,50);
boyx.addImage(boyy)
boyx.scale=0.5
   score = 0  
  redB= new Group();
